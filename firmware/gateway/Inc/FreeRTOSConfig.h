 ...
 * @brief FreeRTOS configuration for the L475 Gateway.
 *
 ...
 *
 * Update co-ordinates: if CPU_SYSCLK_HZ changes in
 * firmware/gateway/drivers/cpu/cpu.c, update configCPU_CLOCK_HZ to match.
 * Identical to the Field Device config (firmware/field-device/Inc/
 * FreeRTOSConfig.h) except configCPU_CLOCK_HZ (80 MHz, not 180 MHz) —
 * Cortex-M4 priority-bit layout is the same on both boards (4 bits).
 */

#ifndef FREERTOS_CONFIG_H
#define FREERTOS_CONFIG_H

/* --- Cortex-M4 port settings -------------------------------------------- */
...
/* L475 = Cortex-M4 with 4 priority bits, lowest priority is 15.
