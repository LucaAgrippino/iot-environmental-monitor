 ...
 * scripts/gen-panic-symbols.py) — declared here so cpu.c can reference
 * them; not needed by panic_symbol_lookup() itself, which takes any table
 * as a parameter instead (see its own doc comment below). */
