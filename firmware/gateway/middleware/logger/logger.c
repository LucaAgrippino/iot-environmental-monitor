/**
 * @file logger.c
 * @brief Logger Middleware implementation (Gateway).
 *
 ...
 *
 * See docs/lld/middleware/logger.md v0.3 for the full design. Identical
 * logic to the Field Device implementation
 * (firmware/field-device/middleware/logger/logger.c) — only the driver
 * include paths differ, since Gateway and Field Device are separate
 * CubeIDE projects with separate source trees.
 */
