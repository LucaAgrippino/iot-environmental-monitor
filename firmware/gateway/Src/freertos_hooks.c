 ...
 *
 * Identical to the Field Device hooks (firmware/field-device/Src/
 * freertos_hooks.c) except the CMSIS include (stm32l475xx.h, not
 * stm32f469xx.h).
 */
...
#include "stm32l475xx.h" /* for __disable_irq() */
