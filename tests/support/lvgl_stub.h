...
extern lv_font_t lv_font_montserrat_10; /* defined in lvgl_stub.c */
extern lv_font_t lv_font_montserrat_12; /* defined in lvgl_stub.c */
extern lv_font_t lv_font_montserrat_14; /* defined in lvgl_stub.c */
extern lv_font_t lv_font_montserrat_48; /* defined in lvgl_stub.c */
...
static inline void lv_style_set_border_width(lv_style_t *s, lv_coord_t w)
{
    (void) s;
    (void) w;
}
static inline void lv_style_set_border_opa(lv_style_t *s, lv_opa_t o)
{
    (void) s;
    (void) o;
}
static inline void lv_style_set_pad_all(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
static inline void lv_style_set_pad_hor(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
static inline void lv_style_set_pad_ver(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
static inline void lv_style_set_pad_top(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
static inline void lv_style_set_pad_bottom(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
static inline void lv_style_set_pad_left(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
static inline void lv_style_set_pad_right(lv_style_t *s, lv_coord_t p)
{
    (void) s;
    (void) p;
}
...
static inline void lv_style_set_text_letter_space(lv_style_t *s, lv_coord_t sp)
{
    (void) s;
    (void) sp;
}
static inline void lv_style_set_opa(lv_style_t *s, lv_opa_t o)
{
    (void) s;
    (void) o;
}
...
static inline void lv_obj_add_style(lv_obj_t *o, lv_style_t *s, lv_style_selector_t sel)
{
    (void) o;
    (void) s;
    (void) sel;
...
static inline void lv_obj_set_style_bg_color(lv_obj_t *o, lv_color_t c, lv_style_selector_t s)
{
    (void) o;
    (void) c;
    (void) s;
}
static inline void lv_obj_set_style_bg_opa(lv_obj_t *o, lv_opa_t a, lv_style_selector_t s)
{
    (void) o;
    (void) a;
    (void) s;
}
static inline void lv_obj_set_style_border_color(lv_obj_t *o, lv_color_t c, lv_style_selector_t s)
{
    (void) o;
    (void) c;
    (void) s;
}
static inline void lv_obj_set_style_border_width(lv_obj_t *o, lv_coord_t w, lv_style_selector_t s)
{
    (void) o;
    (void) w;
    (void) s;
}
static inline void lv_obj_set_style_border_opa(lv_obj_t *o, lv_opa_t a, lv_style_selector_t s)
{
    (void) o;
    (void) a;
    (void) s;
}
static inline void lv_obj_set_style_text_color(lv_obj_t *o, lv_color_t c, lv_style_selector_t s)
{
    (void) o;
    (void) c;
    (void) s;
}
static inline void lv_obj_set_style_text_font(lv_obj_t *o, const lv_font_t *f,
...
static inline void lv_obj_set_style_pad_all(lv_obj_t *o, lv_coord_t p, lv_style_selector_t s)
{
    (void) o;
    (void) p;
    (void) s;
}
static inline void lv_obj_set_style_pad_top(lv_obj_t *o, lv_coord_t p, lv_style_selector_t s)
{
    (void) o;
    (void) p;
    (void) s;
}
static inline void lv_obj_set_style_pad_bottom(lv_obj_t *o, lv_coord_t p, lv_style_selector_t s)
{
    (void) o;
    (void) p;
    (void) s;
}
static inline void lv_obj_set_style_pad_left(lv_obj_t *o, lv_coord_t p, lv_style_selector_t s)
{
    (void) o;
    (void) p;
    (void) s;
}
static inline void lv_obj_set_style_pad_right(lv_obj_t *o, lv_coord_t p, lv_style_selector_t s)
{
    (void) o;
    (void) p;
    (void) s;
}
static inline void lv_obj_set_style_radius(lv_obj_t *o, lv_coord_t r, lv_style_selector_t s)
{
    (void) o;
    (void) r;
    (void) s;
}
static inline void lv_obj_set_style_opa(lv_obj_t *o, lv_opa_t a, lv_style_selector_t s)
{
    (void) o;
    (void) a;
    (void) s;
}
static inline void lv_obj_set_style_shadow_width(lv_obj_t *o, lv_coord_t w, lv_style_selector_t s)
{
    (void) o;
    (void) w;
    (void) s;
...
static inline void lv_obj_set_width(lv_obj_t *o, lv_coord_t w)
{
    (void) o;
    (void) w;
}
static inline void lv_obj_set_height(lv_obj_t *o, lv_coord_t h)
{
    (void) o;
    (void) h;
}
...
static inline void lv_obj_align(lv_obj_t *o, lv_align_t a, lv_coord_t x, lv_coord_t y)
{
    (void) o;
    (void) a;
    (void) x;
...
static inline void lv_obj_set_align(lv_obj_t *o, lv_align_t a)
{
    (void) o;
    (void) a;
}
