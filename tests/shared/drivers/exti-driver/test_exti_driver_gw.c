/**
 * @file test_exti_driver_gw.c
 * @brief Unit tests for ExtiDriver — Gateway (STM32L475) register layout.
 *
 ...
 * the L475 multi-bank register names (IMR1/RTSR1/FTSR1/PR1); see
 * test_exti_driver_fd.c for the F469 single-bank names (IMR/RTSR/FTSR/PR).
 ...
 *
 * Build: STM32L475xx and TEST must be defined (project.yml :test_exti_driver_gw:).
 */
