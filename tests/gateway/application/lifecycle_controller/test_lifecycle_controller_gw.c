...
static config_service_err_t spy_set_param(config_param_id_t id, const void *v)
{
    (void) id;
    (void) v;
    return CONFIG_SERVICE_OK;
}
static config_service_err_t spy_validate_param(config_param_id_t id, const void *v)
{
    (void) id;
    (void) v;
    return CONFIG_SERVICE_OK;
...
{
    return g_sensors_is_ready_return;
}
...
static gw_svc_err_t spy_cloud_init(void)
{
    g_cloud_init_calls++;
    return g_cloud_init_return;
}
static gw_svc_err_t spy_cloud_flush(void)
{
    g_cloud_flush_calls++;
    return GW_SVC_ERR_OK;
}
static bool spy_cloud_is_ready(void)
{
    return g_cloud_is_ready_return;
}
static gw_svc_err_t spy_cloud_report_rollback_result(void)
{
    g_cloud_rollback_result_calls++;
    return GW_SVC_ERR_OK;
}
...
static gw_svc_err_t spy_modbus_poller_init(void)
{
    g_modbus_poller_init_calls++;
    return g_modbus_poller_init_return;
}
static bool spy_modbus_poller_is_ready(void)
{
    return g_modbus_poller_is_ready_return;
}
...
static gw_svc_err_t spy_update_init(void)
{
    return GW_SVC_ERR_OK;
}
static gw_svc_err_t spy_update_start(uint32_t sz)
{
    (void) sz;
    g_update_start_calls++;
    return GW_SVC_ERR_OK;
}
static gw_svc_err_t spy_update_resume_self_checking(void)
{
    g_update_resume_self_checking_calls++;
    return GW_SVC_ERR_OK;
}
static gw_svc_err_t spy_update_resume_rollback(void)
{
    g_update_resume_rollback_calls++;
    return GW_SVC_ERR_OK;
}
static gw_svc_err_t spy_update_resume_after_rollback(void)
{
    g_update_resume_after_rollback_calls++;
    return GW_SVC_ERR_OK;
}
...
/* --- time_service spy -------------------------------------------------- */
static gw_svc_err_t spy_time_service_init(void)
{
    return GW_SVC_ERR_OK;
}
...
static gw_svc_err_t spy_firmware_store_get_pending_flags(bool *sc_out, bool *rb_out)
{
    if (sc_out)
    {
        *sc_out = g_firmware_store_self_check_pending;
    }
    if (rb_out)
    {
        *rb_out = g_firmware_store_rollback_pending;
    }
    return GW_SVC_ERR_OK;
}
static gw_svc_err_t spy_firmware_store_confirm_self_check(void)
{
    g_firmware_store_confirm_calls++;
    return GW_SVC_ERR_OK;
}
static gw_svc_err_t spy_firmware_store_rollback(void)
{
    g_firmware_store_rollback_calls++;
    return GW_SVC_ERR_OK;
}
...
static void spy_soft_reset(void)
{
    g_reset_driver_soft_reset_calls++; /* no return in production */
}
...
static health_admin_err_t spy_health_admin_reset_metrics(void)
{
...
static lifecycle_err_t do_gw_init(void)
{
    return lifecycle_controller_init(
        ...
        &g_sensors_spy, &g_alarms_spy, &g_console_spy, (const ihealth_report_t *) &g_health_spy,
        &g_cloud_spy, &g_modbus_poller_spy, &g_update_spy, &g_time_service_spy,
        &g_firmware_store_spy, &g_reset_driver_spy, &g_health_admin_spy);
}
